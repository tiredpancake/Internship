...
task("icons_components", function () {
    return _src([svg_files_folder + "/*.svg"])
        .pipe(
            svgmin({
                multipass: true,
                full: true,
        ...
        .pipe(dest(dest_folder + "/src"));
});

task("icons_component_main", function (cb) {
    return writeFile(
...
task("default", series("icons_components", "icons_component_main"));